    ...
    async def start(self, *args, **kwargs):
        ...
        try:
            await self.set_bot_commands([
                ...
                BotCommand("settings", "ᴍᴀɴᴀɢᴇ ᴅᴜᴍᴘ ᴄʜᴀɴɴᴇʟ, sᴛɪᴄᴋᴇʀ & ᴄᴀᴘᴛɪᴏɴ"),
                BotCommand("set_caption", "sᴇᴛ ᴄᴀᴘᴛɪᴏɴ ᴛᴇᴍᴘʟᴀᴛᴇ"),
                BotCommand("del_caption", "ʀᴇᴍᴏᴠᴇ ᴄᴀᴘᴛɪᴏɴ ᴛᴇᴍᴘʟᴀᴛᴇ"),
                BotCommand("caption_info", "ᴠɪᴇᴡ ᴄᴀᴘᴛɪᴏɴ ᴛᴇᴍᴘʟᴀᴛᴇ"),
                BotCommand("add_dump", "sᴇᴛ ᴅᴜᴍᴘ ᴄʜᴀɴɴᴇʟ"),
                BotCommand("del_dump", "ʀᴇᴍᴏᴠᴇ ᴅᴜᴍᴘ ᴄʜᴀɴɴᴇʟ"),
